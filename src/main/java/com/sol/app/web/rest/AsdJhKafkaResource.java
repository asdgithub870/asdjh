...
@RestController
@RequestMapping("/api/asd-jh-kafka")
public class AsdJhKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AsdJhKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AsdJhKafkaResource(KafkaProperties kafkaProperties) {
